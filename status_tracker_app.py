...
def check_password():
    ...
    def password_entered():
        """Überprüft, ob das eingegebene Passwort mit den Secrets übereinstimmt."""
        # Holt das Passwort aus den Secrets (Cloud) oder nutzt ein Standard-Passwort für lokales Testen
        correct_password = st.secrets.get("password", "geheim123")
...
# Falls das Passwort NICHT korrekt ist, stoppt das Skript hier
...
st.caption("Ein maßgeschneidertes Tool zum Dokumentieren der Aufgaben mit automatischem speichern erledigter Aufgaben in Google-Docs.")
